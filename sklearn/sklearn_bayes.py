#https://ailearning.apachecn.org/#/docs/ml/4
# -*- coding:utf-8 -*-
'''
...
def spamTest():
    ...
    for i in range(1, 26):
        # 切分，解析数据，并归类为 1 类别
        wordList = textParse(open('4.NaiveBayes/email/spam/%d.txt' % i,errors='ignore').read())
        docList.append(wordList)
        classList.append(1)
        # 切分，解析数据，并归类为 0 类别
        wordList = textParse(open('4.NaiveBayes/email/ham/%d.txt' % i,errors='ignore').read())
        docList.append(wordList)
